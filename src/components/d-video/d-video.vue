        ...
        methods: {
            initEvent() {
                ...
                this.$refs.video.addEventListener('timeupdate', function(e) {
                    ...
                    if (Math.floor(vm.currentTime) > vm.currentTimeFloor) {
                        vm.currentTimeFloor = Math.floor(vm.currentTime);
                        vm.$emit('on-timeupdate', vm.currentTimeFloor, vm.$refs.video);
                    }
                });
            ...
            initAttr() {
                ...
                this.$refs.video.style.width = this.width;
                this.$refs.video.style.height = this.height;
                // 退出全屏
